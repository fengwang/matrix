...
int main()
{
    ...
    if ( 1 )
    {
        ...
        mt.save_as_bmp( "./matrix/stone.bmp");
        mt.save_as_pgm( "./matrix/stone.pgm");
    }
    ...
    if ( 0 )
    {
        ...
        mt.load("./matrix/stone.txt");
        assert( mt.row() == 2048 );
        for ( unsigned long index = 0; index != 1024; ++index )
            std::swap_ranges( mt.row_begin(index), mt.row_end(index), mt.row_begin(2047-index) );
        mt.save_as( "./matrix/new_stone.txt" );
    }
    ...
    if ( 0 )
    {
        ...
        mt.save_as_pgm( "demo_default.pgm");
        mt.load("./matrix/demo2.txt");
        mt.save_as_pgm( "demo2_default.pgm");

        mt.save_as_bmp( "demo2_default.bmp" );
        mt.save_as_bmp( "demo2_gray.bmp", "gray" );
        mt.save_as_bmp( "demo2_hotblue.bmp", "hotblue" );
        mt.save_as_bmp( "demo2_jet.bmp", "jet" );
        mt.save_as_bmp( "demo2_obscure.bmp", "obscure" );
    }
    ...
    if ( 0 )
    {
        ...
        mt.save_as_bmp( "Si_se_d40t40_revised_hotblue.bmp", "hotblue", "log2" );
        mt.save_as_bmp( "Si_se_d40t40_revised_jet.bmp", "jet", "log2" );
        mt.save_as_bmp( "Si_se_d40t40_revised_jet.bmp", "obscure", "log2" );

        mt.save_as_bmp( "Si_se_d40t40_revised_1.bmp", "default", "log1" );
        mt.save_as_bmp( "Si_se_d40t40_revised_hotblue_1.bmp", "hotblue", "log1" );
        mt.save_as_bmp( "Si_se_d40t40_revised_jet_1.bmp", "jet", "log1" );

        mt.save_as_bmp( "Si_se_d40t40_revised_3.bmp", "default", "log3" );
        mt.save_as_bmp( "Si_se_d40t40_revised_hotblue_3.bmp", "hotblue", "log3" );
        mt.save_as_bmp( "Si_se_d40t40_revised_jet_3.bmp", "jet", "log3" );
    }
    ...
    if ( 0 )
    {
        f::matrix<double> mt;
        mt.load("Si_se_d40t40.txt");
        mt.save_as_bmp( "Si_se_d40t40_revised_jet.bmp", "obscure"  );
        mt.save_as_bmp( "Si_se_d40t40_revised_jet_log.bmp", "obscure", "log" );
        mt.save_as_bmp( "Si_se_d40t40_revised_jet_log1.bmp", "obscure", "log1" );
        mt.save_as_bmp( "Si_se_d40t40_revised_jet_log2.bmp", "obscure", "log2" );
        mt.save_as_bmp( "Si_se_d40t40_revised_jet_log3.bmp", "obscure", "log3" );
    }
