...
int main()
{
    ...
    f::matrix<double> df = f::gradient_x2(nt) - f::gradient_x2(nt.transpose()).transpose();
    ...
    std::ofstream ofs_rws{ "./matrix/demo4_inverse_laplace_coords_cmt.txt" };
    std::ofstream ofs_ws{ "./matrix/demo4_inverse_laplace_weights_cmt.txt" };

    std::ofstream ofs_mtx{ "./matrix/demo4_coordinates_cmt.mtx" };
    ...
    df.save_as_bmp( "./diff_cmt.bmp", "gray" );


    nl.save_as_bmp( "./new_lap_gray_log1_cmt.bmp", "gray", "log1" );

    std::ofstream ofs_demo4( "./matrix/demo4_1d_cmt.txt" );
    ofs_demo4.precision( 15 );
    std::copy( nt.begin(), nt.end(), std::ostream_iterator<double>( ofs_demo4, "\n" ) );
    ...
    rws.save_as( "./matrix/demo4_inverse_laplace_coords.txt" );
    ws.save_as( "./matrix/demo4_inverse_laplace_weights.txt" );
    */
