...
int main()
{
    if ( 0 )
    {
        ...
        for ( unsigned long k = 0; k != total; ++k )
        {
            std::string tk = f::lexical_cast<std::string>( thickness[k] );
            {
                ...
                image.save_as_inverse_bmp( imag_path );
            }
        }
    }
    ...
    if ( 0 )
    {
        ...
        pd.save_as_inverse_bmp( "SrTiO3_demo_d70_diff.bmp" );
    ...
    if ( 0 )
    {
        ...
        image.save_as_inverse_bmp( "./SrTiO3_abs_d40t40_se");
         
        old_image -= image;
        old_image = f::abs(old_image);
        old_image[0][0] = mx;

        old_image.save_as_inverse_bmp( "./SrTiO3_abs_d40t40_diff");
    }
    ...
    if ( 0 )
    {
        ...
        image.save_as_inverse_bmp( "./matrix/ug/si_potential_map_matrix");
    }
    ...
    if ( 0 )
    {
        ...
        image.save_as_inverse_bmp( "./matrix/ug/si_se_potential_map_matrix");
    }
    ...
    if ( 0 )
    {
        f::matrix<double> image;
        image.load( "./real.txt" );
        image.save_as_inverse_bmp( "real" );
    }
    if ( 0 )
    {
        f::matrix<double> image;
        image.load( "./image.txt" );
        image.save_as_inverse_bmp( "image" );
    }
    ...
    if ( 0 )
    {
        ...
        image.save_as_inverse_bmp( "./matlab/display_experimental/rmap" );
    }
    ...
    if ( 0 )
    {
        ...
        image.save_as_inverse_bmp( "./matlab/display_experimental/imap" );
    }
    ...
    if ( 0 )
    {
        ...
        image.save_as_inverse_bmp( "./rand_image" );
    }
    ...
    if ( 1 )
    {
        ...
        mt.save_as_inverse_bmp( "Si_se_d40t40_revised.bmp" );
    }
